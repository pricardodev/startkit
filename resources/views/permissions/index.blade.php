            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="text-success" href="{{ route('criar.permissao') }}">&plus; Cadastrar Permissões</a>
                        ...
                        <table class="table table-bordered table-hover table-striped mt-4">
                           ...
                           @forelse($permissions as $permission)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a class="mr-3 btn btn-sm btn-outline-success" href="{{ route('editar.permissao', ['permissao' => $permission->id] ) }}">Editar</a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('deletar.permissao', ['permissao' => $permission->id]) }}" method="post">
                                                    @csrf
                                                    @method('delete')
